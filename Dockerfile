...
#Spark
RUN wget -O - https://archive.apache.org/dist/spark/spark-2.2.1/spark-2.2.1-bin-hadoop2.7.tgz | tar zx
RUN mv /spark* /spark
...
#HBase
RUN wget -O - https://www.apache.org/dist/hbase/1.2.6.1/hbase-1.2.6.1-bin.tar.gz | tar zx
RUN mv /hbase* /hbase
...
RUN wget -O - https://www.apache.org/dist/predictionio/0.12.1/apache-predictionio-0.12.1-bin.tar.gz | tar zx
